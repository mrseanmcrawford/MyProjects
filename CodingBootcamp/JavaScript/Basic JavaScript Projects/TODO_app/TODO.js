...
function get_todos() {
    /*This creates an array of task that was savesd in the web browser memory*/
    var todos = new Array;
    /*This pulls the task that was saved in the web browsers memory*/
    var todos_str = localStorage.getItem('todo');
    /*If the input is not null then JSON.parse will communicate with the we browseer to make the
    task a JavaScript object.*/
    if (todos_str !== null) {
...
/*This displays the inputed tas when the 'Add Item' button is clicked*/
