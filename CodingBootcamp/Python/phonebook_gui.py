...
def load_gui(self):
    ...
    self.lbl_fname.grid(row=0,column=0,padx=(27,0),pady=(10,0),sticy=N+W)
    ...
    self.lbl_User.grid(row=0,column=0,padx=(0,0),sticky=N+W)
    ...
    #Define the listbnox with a scrollbar and grid them
    ...
    self.scrollbar.grid(row=1,column=5,rowspan=7, columspan=1,padx=(0,0),pady(0,0),sticky=N+E+S)
    self.1stList1.grid(row=1,column=2,rowspan=7,columnspan=1,padx=(15,0),pady=(45,10),sticky=E)

    self.btn_add = tk.Button(self.master,width=12,height=2,text='Add',command=lambda: phonebook_func.addtoList(self))
    self.btn_add.grid(row=8,column=0,padx(25,0),pady=(45,10),sticky=W)
    self.btn_update = tk.Button(self.master,width=12,height=2,text='Update',command=lambda: phonebook_func.onUpdatet(self))
    sef.btn_update.grid(row=8,column=1,padx(15,0),pady=(45,10),sticky=W)
